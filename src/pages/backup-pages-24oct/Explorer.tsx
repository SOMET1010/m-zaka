            ...
            <div className="text-center mb-12 animate-fade-in relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-body-lg text-muted-foreground max-w-2xl mx-auto">
                  Découvrez tous nos biens immobiliers certifiés à travers la Burkina Faso
                </p>
              </div>
            </div>
            ...
            <section className="mb-8">
              <div className="relative h-40 md:h-48 rounded-lg overflow-hidden shadow-lg">
                <LazyIllustration 
                  ...
                  alt="Quartier d'Ouagadougou"
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
                  <div className="text-white p-6">
                    <h2 className="text-2xl font-bold">Explorez les quartiers d'Ouagadougou</h2>
